...
void gen_response1(const Request& req, Response& res) {
    ...
    auto clientWeather = cli1.Get("/data/2.5/onecall?lat=44.5653&lon=34.0615&lang=ru&units=metric&exclude=current,minutely,daily,alerts&appid=7a0b93a49400af0720c76dd9ddee7ade");
    if (clientTime) {
